            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                     ...
                     <form method="post" action="<?php echo base_url().'index.php/c_pakar/simpan_gejala'?>">
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Gejala" value="">
                                </div>
                            </div>
                            </div>
                 ...
                 <div class="modal fade" id="Modaledit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                     ...
                     <form method="post" action="<?php echo base_url().'index.php/c_pakar/edit_gejala'?>">
                            <div class="modal-body">
...
<script type="text/javascript">
    ...
    if (r == true) {
        window.location ="<?php echo site_url('c_pakar/hapus_gejala?id='); ?>"+id;
      } else {
      }
    }
</script>
