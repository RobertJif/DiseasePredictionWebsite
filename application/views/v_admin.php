            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                     ...
                     <form method="post" action="<?php echo base_url().'index.php/c_pakar/simpan_admin'?>">
                 ...
                 <div class="modal fade" id="Modaledit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                     ...
                     <form method="post" action="<?php echo base_url().'index.php/c_pakar/edit_admin'?>">
                            <div class="modal-body">
...
<script type="text/javascript">
    ...
    if (r == true) {
        window.location ="<?php echo site_url('c_pakar/hapus_admin?id='); ?>"+id;
      } else {
      }
    }
</script>
