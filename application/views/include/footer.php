 ...
 <!-- ============================================================== -->
    ...
    <!-- this page js -->
    <script src="<?php echo base_url('assets/backend/assets/extra-libs/multicheck/datatable-checkbox-init.js');?>"></script>
    <script src="<?php echo base_url('assets/backend/assets/extra-libs/multicheck/jquery.multicheck.js');?>"></script>
